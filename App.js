          ...
          <View style={styles.body}>
            <View style={styles.sectionContainer}>
              ...
              <Text style={styles.sectionDescription}>
                Ideally, you should check if Apple Pay is enable in background,
                and then accordingly call the payment method. Showing here on
                button action for demo purpose.
              </Text>
